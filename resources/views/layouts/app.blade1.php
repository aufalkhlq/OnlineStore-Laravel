...
<section class="smart-scroll">
    <div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-dark">
            <a class="navbar-brand heading-black" href="{{ route('home.index') }}">
                GADGED IN
            </a>
        ...
        <div class="row mt-6">
            ...
            <div class="col-md-5">
                <div class="slick-about">
                    <img src="{{ asset("/img/blog-1.jpg") }}" class="img-fluid rounded d-block mx-auto" alt="Work 1"/>
                    <img src="{{ asset("/img/blog-2.jpg") }}" class="img-fluid rounded d-block mx-auto" alt="Work 2"/>
                    <img src="{{ asset("/img/blog-3.jpg") }}" class="img-fluid rounded d-block mx-auto" alt="Work 3"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-md-6 mx-auto text-center">
                ...
                <a href="{{ url("#") }}" class="btn btn-primary">Contact us</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-md-4">
                <div class="card">
                    <a href="{{ url("#") }}">
                        <img class="card-img-top img-raised" src="{{ asset("/img/blog-1.jpg") }}" alt="Blog 1">
                    </a>
                    <div class="card-body">
                        <a href="{{ url("#") }}" class="card-title mb-2"><h5>We launch new iOS & Android mobile apps</h5></a>
                        ...
                        <p class="card-text">Nam liber tempor cum soluta nobis eleifend option congue nihil imper,
                            consectetur adipiscing elit. <a href="{{ url("#") }}">Learn more</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <a href="{{ url("#") }}">
                        <img class="card-img-top img-raised" src="{{ asset("/img/blog-2.jpg") }}" alt="Blog 2">
                    </a>
                    <div class="card-body">
                        <a href="{{ url("#") }}" class="card-title mb-2"><h5>New update is available for the editor</h5></a>
            ...
            <div class="col-md-4">
                <div class="card">
                    <a href="{{ url("#") }}">
                        <img class="card-img-top img-raised" src="{{ asset("/img/blog-3.jpg") }}" alt="Blog 3">
                    </a>
                    <div class="card-body">
                        <a href="{{ url("#") }}" class="card-title mb-2"><h5>The story of building #1 page builder</h5></a>
        ...
        <div class="row mt-6">
            <div class="col-md-6 mx-auto text-center">
                <a href="{{ url("#") }}" class="btn btn-primary">View all posts</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-sm-5 mr-auto">
                ...
                <ul class="list-inline social social-sm">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ url("") }}"><i class="fa fa-dribbble"></i></a>
                    </li>
                </ul>
            </div>
            <div class="col-sm-2">
            ...
            <div class="col-sm-2">
                <h5>Partner</h5>
                <ul class="list-unstyled">
                    <li><a href="{{ url("#") }}">Refer a friend</a></li>
